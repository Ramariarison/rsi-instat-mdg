            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between gap-2 h-16">
                    <div class="flex mr-2">
                        ...
                        <div class="shrink-0 flex items-center">
                            <Link :href="route('dashboard')">
                                <ApplicationLogo
                                    class="block h-auto w-12 fill-current text-gray-800 dark:text-gray-200"
                                />
                            </Link>
                        </div>
                    ...
                    <div class="flex items-center gap-3 flex-1">
                        <TextInput v-model="keywords" placeholder="Rechercher sur le site web" class="w-full"
                                   @keyup.enter="search"/>
                ...
                <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                    <template v-if="authUser">
                        ...
                        <div class="mt-3 space-y-1">
                            <ResponsiveNavLink :href="route('profile', {username: authUser.username })">Mon Profil
                            </ResponsiveNavLink>
