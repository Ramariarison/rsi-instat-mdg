            ...
            <div class="px-4">
                ...
                <div class="group relative bg-white dark:bg-slate-950 dark:text-gray-100">
                    ...
                    <div class="flex">
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-center flex-1 p-4">
                            <h2 class="font-bold text-lg mb-4 sm:mb-0">{{ group.name }}</h2>
                ...
                <TabGroup>
                    <TabList class="flex bg-white dark:bg-slate-950 dark:text-white">
                        <Tab v-slot="{ selected }" as="template">
                            <TabItem text="Pub" :selected="selected"/>
                        </Tab>
                        <Tab v-if="isJoinedToGroup" v-slot="{ selected }" as="template">
                            <TabItem text="Membre" :selected="selected"/>
                        </Tab>
                        <Tab v-if="isCurrentUserAdmin" v-slot="{ selected }" as="template">
                            <TabItem text="Demande" :selected="selected"/>
                        </Tab>
                        <Tab v-slot="{ selected }" as="template">
                            <TabItem text="Photo" :selected="selected"/>
                        </Tab>
                        <Tab v-slot="{ selected }" as="template">
                            <TabItem text="A propos" :selected="selected"/>
                        </Tab>
                    </TabList>
                    ...
                    <TabPanels class="mt-2">
                        <TabPanel>
                            <template v-if="posts">
                                ...
                                <div v-else class="py-8 text-center dark:text-gray-100">
                                    Il n'y a aucun publication dans cet groupe. Soyez le premier à publier.
                                </div>
                            </template>
                            <div v-else class="py-8 text-center dark:text-gray-100">
                        ...
                        <TabPanel v-if="isJoinedToGroup">
                            <div class="mb-3">
                                <TextInput :model-value="searchKeyword" placeholder="Tapez pour rechercher" class="w-full"/>
                            </div>
                        ...
                        <TabPanel v-if="isCurrentUserAdmin" class="">
                            ...
                            <div class="py-8 text-center dark:text-gray-100">
                                Il n'y a aucun demande en cours.
                            </div>
                        </TabPanel>
                        <TabPanel>
